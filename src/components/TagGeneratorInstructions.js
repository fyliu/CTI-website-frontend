        ...
        <Container className={classes.containerPadding}>
          <Grid container>
            <Grid item xs={12} style={{ padding: '24px 0px' }}>
              <Typography variant='h6' className={classes.typoStyle}>
                {' '}
                1. Navigate to your project&apos;s repository in another browser to add your
                generated tags.
              </Typography>
            </Grid>
            <StepComp
              stepText='2. Under your project’s repository, click to paste your tags.'
              src='/images/step_2.svg'
              alt='Step 2'
            />
            <StepComp
              stepText='3. Under "Topics", paste the topic you want to add to your repository.'
              src='/images/step_3.svg'
              alt='Step 3'
            />
            <StepComp
              stepText='4. Repeat until you have finished adding all of your tags, then click Save Changes.'
              src='/images/step_4.svg'
              alt='Step 4'
            />
          </Grid>
        </Container>
